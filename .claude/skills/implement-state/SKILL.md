...
> **One task per invocation.** This is intentional: small verifiable diffs (CLAUDE.md
...
Follow CLAUDE.md and `specs/architecture.md`:
...
A green bar is **mandatory** before checking `☑` (CLAUDE.md *Evidence Before
Conclusion*). Run:
...
- the acceptance criteria are **ambiguous** or several interpretations exist
  (CLAUDE.md *Understand Before Coding*);
